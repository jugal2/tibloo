...
class EmploymentPage extends StatefulWidget {
  const EmploymentPage({Key? key}) : super(key: key);
...
class _EmploymentPageState extends State<EmploymentPage> {
  ...
  Future<String> getEmploymentPage() async {
    print("EmploymentPage Data Api Runs");
    ...
    var res = await http.post(
        Uri.parse(global.api_base_url + "get_EmploymentPage_data"),
        headers: {
